...
<div class="top-ranked-colleges py-100 pt-0 wow fadeInUp test-college-country">
   <div class="container">
        ...
        <div class="title-seciton py-3 py-lg-5 wow fadeInUp">
        	@if($cData->banner != '')
            	<div class="col-md-12">
                <img src="{{URL::asset('public/admin/images/blogs')}}/{!! $cData->banner !!}" alt="college banner" style="width: 100%;height: auto;" title="">
                </div>
            @endif
            <h2 class="mb-3 mt-3 text-center blog_title">{!! $cData->title !!}</h2>
            <div class="taketo-first blog_section">
...
<script type="text/javascript">
    ...
    function filterData(type = null){
        ...
        $.ajax({
            ...
            url: "{{ url('/country_colleges_paginate') }}",
