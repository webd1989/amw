              ...
              <div class="card-body">
                <div class="tab-content p-0">
                  <div class="row g-2">
                    ...
                    <div class="col-md-12">
                      <label class="form-label" for="title">iFrame</label>
          ...
          <div class="card mb-6">
            <div class="card-body">
              <div class="pt-6">
                ...
                <button type="reset" onclick="window.location.href='{{route('admin.videos')}}'" class="btn btn-label-secondary" >Cancel</button>
              </div>
            </div>
          </div>
...
var addUrl = "{{url('/panel/edit-video/')}}/{{$record->id}}";
$(document).ready(function(){
