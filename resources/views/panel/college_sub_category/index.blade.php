...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    <h5 class="card-header">College Sub Category <a href="{{route('admin.add-college-sub-category')}}" style="float:right; color:#FFF" class="btn btn-success waves-effect waves-light">Add</a></h5>
...
<script type="text/javascript">
    ...
    function filterData(type = null){
        ...
        $.ajax({
            ...
            url: "{{ url('/panel/college_sub_categories_paginate') }}",
