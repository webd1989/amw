...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="row">
    <div class="col"> 
      <h6 class="mt-6">Add College Sub Category</h6>
      <div class="row">
                      ...
                      <div class="col-md-12">
                        ...
                        <ul class="list-group state-scroll">
                          ...
                          <li class="list-group-item">
                            <input class="form-check-input me-1" name="state_id[]" type="checkbox" value="{{$key}}" id="{{$key}}">
          ...
          <div class="card mb-6">
            <div class="card-body">
              <div class="pt-6">
                ...
                <button type="reset" onclick="window.location.href='{{route('admin.college-categories')}}'" class="btn btn-label-secondary" >Cancel</button>
              </div>
            </div>
          </div>
        </div>
...
var addUrl = "{{route('admin.add-college-sub-category')}}";
$(document).ready(function(){
				...
				var obj = JSON.parse(response);
				 if(obj['heading'] == "Success"){
					swal("", obj['msg'], "success").then((value) => {
						window.location.href = "{{url('/panel/edit-college-sub-category/')}}/"+obj['row_id'];
					});
				}else{
