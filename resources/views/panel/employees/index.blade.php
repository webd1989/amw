...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    <h5 class="card-header">Employee <a href="{{route('admin.add-employee')}}" style="float:right; color:#FFF" class="btn btn-success waves-effect waves-light">Add</a></h5>
...
<script type="text/javascript">
    ...
    function filterData(type = null){
        ...
        $.ajax({
            ...
            url: "{{ url('/panel/employees_paginate') }}",
