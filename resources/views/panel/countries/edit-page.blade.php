                ...
                <div class="tab-content p-0">
                    <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                      <div class="row g-2">
                        ...
                        <div class="col-md-6">
                          <label class="form-label required" for="title">Country Code</label>
                          <input type="text" id="title" name="country_code" value="{{$record->country_code}}" class="form-control"/>
                        </div>
                        <div class="col-md-6">
                          <label class="form-label required" for="title">Phone Code</label>
                          <input type="text" id="phonecode" name="phonecode" value="{{$record->phonecode}}" class="form-control"/>
                        </div>
                        <div class="col-md-12">
                          <label class="form-label" for="title">Description</label>
                          <textarea id="description" name="description" rows="5" class="form-control editorBox">{{$record->description}}</textarea>
                        </div>
                        <div class="col-md-4">
                        ...
                        @if($record->banner != '')                      
                          @if(file_exists(public_path().'/admin/images/blogs/'.$record->banner))
                          <div class="col-md-2 pt-3">
                            <img src="{{URL::asset('public/admin/images/blogs')}}/{!! $record->banner !!}" style="max-width:100px;height: auto;"> 
                          </div>
                          @endif
                        @endif
                      </div>
          ...
          <div class="card mb-6">
            <div class="card-body">
              <div class="pt-6">
                ...
                <button type="reset" onclick="window.location.href='{{route('admin.countries')}}'" class="btn btn-label-secondary" >Cancel</button>
              </div>
            </div>
          </div>
        </div>
...
var addUrl = "{{url('/panel/edit-country/')}}/{{$record->id}}";
$(document).ready(function(){
