                  ...
                  <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                    <div class="row g-2">
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="text" id="contact" name="contact" maxlength="10" class="form-control numberonly"/>
                      </div>
                      <div class="col-md-4">
				...
				var obj = JSON.parse(response);
				 if(obj['heading'] == "Success"){
					swal("", obj['msg'], "success").then((value) => {
						window.location.href = "{{url('/panel/edit-user/')}}/"+obj['row_id'];
					});
				}else{
