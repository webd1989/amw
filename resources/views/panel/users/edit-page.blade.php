              ...
              <div class="card-body">
                <div class="tab-content p-0">
                  <div class="row g-2">
                    ...
                    @if($record->profile != '')                      
                      @if(file_exists(public_path().'/admin/images/banners/'.$year.'/'.$month.'/'.$record->profile))
                      <div class="col-md-2 pt-3">
                        <img src="{{URL::asset('public/admin/images/banners')}}/{{$year}}/{{$month}}/{!! $record->profile !!}" style="max-width:100px;height: auto;"> </div>
                      @endif
                      @endif
                  </div>
                </div>
          ...
          <div class="card mb-6">
            <div class="card-body">
              <div class="pt-6">
                ...
                <button type="reset" onclick="window.location.href='{{route('admin.users')}}'" class="btn btn-label-secondary" >Cancel</button>
              </div>
            </div>
          </div>
        </div>
...
var addUrl = "{{url('/panel/edit-user/')}}/{{$record->id}}";
$(document).ready(function(){
