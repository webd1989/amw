                  ...
                  <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                    <div class="row g-2">
                      <div class="col-md-3">
                        ...
                        <input type="text" id="state" value="{{$record->state}}" name="state" class="form-control" />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="card mb-6">
            <div class="card-body">
              <div class="pt-6">
                ...
                <button type="reset" onclick="window.location.href='{{route('admin.states')}}'" class="btn btn-label-secondary" >Cancel</button>
              </div>
            </div>
          </div>
        </div>
...
var addUrl = "{{url('/panel/edit-state/')}}/{{$record->id}}";
$(document).ready(function(){
