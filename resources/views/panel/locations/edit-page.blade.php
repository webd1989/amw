...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="row">
    <div class="col">
      <h6 class="mt-6">Edit Location</h6>
      <div class="row">
                  ...
                  <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                    <div class="row g-2">
                      <div class="col-md-4">
                        ...
                        <input type="text" id="title" value="{{$record->title}}" name="title" class="form-control" />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="card mb-6">
            <div class="card-body">
              <div class="pt-6">
                ...
                <button type="reset" onclick="window.location.href='{{route('admin.locations')}}'" class="btn btn-label-secondary" >Cancel</button>
              </div>
            </div>
          </div>
        </div>
...
var addUrl = "{{url('/panel/edit-location/')}}/{{$record->id}}";
$(document).ready(function(){
