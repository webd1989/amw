...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="row">
    <div class="col">
      <h6 class="mt-6">Edit Brochure</h6>
      <div class="row">
                ...
                <div class="tab-content p-0">
                  <div class="row g-2">
                    ...
                    <div class="col-md-12">
                      ...
                      <textarea id="description" name="description" rows="5" class="form-control">{{$record->description}}</textarea>
                    </div>
                    <div class="col-md-4">
                      <label class="form-label" for="title">Brochure (pdf)</label>
                      <input type="file" id="image" name="image" accept=".pdf" class="form-control"/>
                    </div>
                    @if($record->image != '')                      
                      @if(file_exists(public_path().'/admin/images/users/'.$record->image))
                      <div class="col-md-2 pt-3">
                      	<br />
                      	<a target="_blank" href="{{URL::asset('public/admin/images/users')}}/{!! $record->image !!}">Download</a>
                      </div>
                      @endif
					@endif
                  </div>
          ...
          <div class="card mb-6">
            <div class="card-body">
              <div class="pt-6">
                ...
                <button type="reset" onclick="window.location.href='{{route('admin.brochures')}}'" class="btn btn-label-secondary" >Cancel</button>
              </div>
            </div>
          </div>
        </div>
...
var addUrl = "{{url('/panel/edit-brochure/')}}/{{$record->id}}";
$(document).ready(function(){
