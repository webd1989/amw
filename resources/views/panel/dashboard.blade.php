  ...
  <div class="row g-6">
    ...
    <div class="col-xl-3 col-sm-6">
      ...
      <div class="card">
        ...
        <a href="{{route('admin.users')}}"><div class="card-header pb-3">

          <h5 class="mb-3 card-title"><i class="icon-base ti tabler-users icon-md"></i> Users</h5>

          <h4 class="mb-0">

          	{{getTotal('customers',1)}}
    ...
    <div class="col-xl-3 col-sm-6">
      ...
      <div class="card">
        ...
        <a href="{{route('admin.colleges')}}"><div class="card-header pb-3">

          <h5 class="mb-3 card-title"><i class="icon-base ti tabler-building icon-md"></i> Colleges</h5>
    ...
    <div class="col-xl-3 col-sm-6">
      ...
      <div class="card">
        ...
        <a href="{{route('admin.enquiries')}}"><div class="card-header pb-3">

          <h5 class="mb-3 card-title"><i class="icon-base ti tabler-message-question icon-md"></i> Enquiry</h5>
    ...
    <div class="col-xl-3 col-sm-6">
      ...
      <div class="card">
        ...
        <a href="{{route('admin.orders')}}"><div class="card-header pb-3">

          <h5 class="mb-3 card-title"><i class="icon-base ti tabler-calendar icon-md"></i> Orders</h5>
