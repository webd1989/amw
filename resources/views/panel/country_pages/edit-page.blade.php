...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="row">
    <div class="col">
      <h6 class="mt-6">Edit Country Page</h6>
      <div class="row">
                  ...
                  <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                    <div class="row g-2">
                      <div class="col-md-3">
						...
						@if(isset($countries) && $countries->count()>0)
                            ...
                            @foreach($countries as $key => $country)
                                <option {{$record->country_id == $key?'selected':''}} value="{{$key}}">{{$country}}</option>
                            @endforeach
                            </select>
                        @endif
                      ...
                      <div class="col-md-8">
                        ...
                        <input type="text" id="slug" name="slug" class="form-control" value="{{$record->slug}}" />
                      </div>                      
                      <div class="col-md-4">
                      ...
                      @endif 
                      <div class="col-md-4">
                        <label class="form-label" for="title">Banner Alt Text</label>
                        <input type="text" id="alt_image" name="alt_image" class="form-control" value="{{$record->alt_image}}" />
                      </div>                     
                      <div class="col-md-12">
                        <label class="form-label" for="title">Introduction</label>
                        <textarea id="description" name="introduction" class="form-control editorBox" rows="4">{{$record->introduction}}</textarea>
                      </div>
                      <div class="col-md-12">
                        <label class="form-label" for="title">Elegibility</label>
                        <textarea id="description" name="elegibility" class="form-control editorBox" rows="4">{{$record->elegibility}}</textarea>
                      </div>
                      <div class="col-md-12">
...
var addUrl = "{{url('/panel/edit-country-page/')}}/{{$record->id}}";
